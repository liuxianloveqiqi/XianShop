...
func (c *userClient) SendCode(ctx context.Context, in *SendCodeRep, opts ...grpc.CallOption) (*SendCodeReply, error) {
...
func (c *userClient) Register(ctx context.Context, in *RegisterReq, opts ...grpc.CallOption) (*CommonReply, error) {
	out := new(CommonReply)
...
func (c *userClient) Login(ctx context.Context, in *LoginReq, opts ...grpc.CallOption) (*CommonReply, error) {
	out := new(CommonReply)
...
func (c *userClient) UserInfo(ctx context.Context, in *UserInfoReq, opts ...grpc.CallOption) (*CommonReply, error) {
	out := new(CommonReply)
...
type UserServer interface {
	SendCode(context.Context, *SendCodeRep) (*SendCodeReply, error)
	Register(context.Context, *RegisterReq) (*CommonReply, error)
	Login(context.Context, *LoginReq) (*CommonReply, error)
	UserInfo(context.Context, *UserInfoReq) (*CommonReply, error)
...
func (UnimplementedUserServer) SendCode(context.Context, *SendCodeRep) (*SendCodeReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendCode not implemented")
}
func (UnimplementedUserServer) Register(context.Context, *RegisterReq) (*CommonReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Register not implemented")
}
func (UnimplementedUserServer) Login(context.Context, *LoginReq) (*CommonReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Login not implemented")
}
func (UnimplementedUserServer) UserInfo(context.Context, *UserInfoReq) (*CommonReply, error) {
...
func _User_SendCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).SendCode(ctx, req.(*SendCodeRep))
	}
